...
## [0.95.0](https://github.com/tiborsimko/reana-client/compare/0.9.6...0.95.0) (2026-09-22)
...
* **auth:** Use this client with the OIDC-compatible REANA server and run reana-client login, or supply an issuer-issued JWT. Legacy opaque REANA tokens no longer authenticate. TLS certificate verification is enabled by default; configure REANA_SERVER_CA_CERTS for private certificates. Replace static-token automation with credentials whose refresh-token lifetime and rotation policy fit the job. For a legacy 0.95 alpha cluster, pin reana-client==0.95.0a5 and reana-commons==0.95.0a22.
...
* **docker:** add build deps for jq and lxml ([#763](https://github.com/tiborsimko/reana-client/issues/763)) ([9a04527](https://github.com/tiborsimko/reana-client/commit/9a04527aa15ca38c66cc24e118832cb433f654c4))
...
* **python:** add support for Python 3.14 ([#753](https://github.com/tiborsimko/reana-client/issues/753)) ([191859d](https://github.com/tiborsimko/reana-client/commit/191859d83cdd953359ced997e631e55ca633fe5a))
* **python:** add support for Python 3.15 ([#781](https://github.com/tiborsimko/reana-client/issues/781)) ([18af026](https://github.com/tiborsimko/reana-client/commit/18af026b20df40f442b6b1fa4af545b40c3e37eb))
...
* **python:** bump shared REANA packages as of 2025-01-09 ([#757](https://github.com/tiborsimko/reana-client/issues/757)) ([1748ef5](https://github.com/tiborsimko/reana-client/commit/1748ef5aa85e76017938d405c4967f4976da70f7))
...
* **python:** pin setuptools below 81 ([#763](https://github.com/tiborsimko/reana-client/issues/763)) ([7d35fa0](https://github.com/tiborsimko/reana-client/commit/7d35fa0b55bde963fb9300feb40d4b94e4f5e369)), closes [#761](https://github.com/tiborsimko/reana-client/issues/761)
* **python:** relax pathspec version constraint ([#758](https://github.com/tiborsimko/reana-client/issues/758)) ([d131a25](https://github.com/tiborsimko/reana-client/commit/d131a25880a9f97578e6a2c57177bec6a5034d4e))
...
* **auth:** add OIDC login and credential management ([#777](https://github.com/tiborsimko/reana-client/issues/777)) ([fc63653](https://github.com/tiborsimko/reana-client/commit/fc63653a8c89d1d58a9925d6280e34836d8d77af))
...
* **client:** manage saved REANA server connections ([#796](https://github.com/tiborsimko/reana-client/issues/796)) ([dd273d6](https://github.com/tiborsimko/reana-client/commit/dd273d62a5585c08bae3818e5d60361c642ec55b))
* **client:** save server and TLS settings at login ([#793](https://github.com/tiborsimko/reana-client/issues/793)) ([15fbaa7](https://github.com/tiborsimko/reana-client/commit/15fbaa7335bdb63d84e623a020f2b4209aec4fb7))
* **etc:** add bash and zsh shell completion files ([#756](https://github.com/tiborsimko/reana-client/issues/756)) ([aa091f0](https://github.com/tiborsimko/reana-client/commit/aa091f0f28de46ba026040458408907ad2ed39e1))
* **info:** display server-side quota period settings ([#772](https://github.com/tiborsimko/reana-client/issues/772)) ([3141bc0](https://github.com/tiborsimko/reana-client/commit/3141bc0349fe1ec928d5e8f0e901c1904e1f2641)), closes [#771](https://github.com/tiborsimko/reana-client/issues/771)
* **quotas:** show quota period in quota-show ([#772](https://github.com/tiborsimko/reana-client/issues/772)) ([0cf2b53](https://github.com/tiborsimko/reana-client/commit/0cf2b53b076c496c3b4377b1bd0bf14f09b7ee22)), closes [#771](https://github.com/tiborsimko/reana-client/issues/771)
* **utils:** show Dask service logs ([#769](https://github.com/tiborsimko/reana-client/issues/769)) ([36f23b2](https://github.com/tiborsimko/reana-client/commit/36f23b2c06141ffed87ec164ebff1b458c8a970a)), closes [#768](https://github.com/tiborsimko/reana-client/issues/768)
* **validation:** add workflow image vetting to validate command ([#749](https://github.com/tiborsimko/reana-client/issues/749)) ([56ec5b0](https://github.com/tiborsimko/reana-client/commit/56ec5b0206a6ebe0d0be951749394e76e02be1a3))
* **validation:** move workflow loading and validation to server ([#779](https://github.com/tiborsimko/reana-client/issues/779)) ([619acaf](https://github.com/tiborsimko/reana-client/commit/619acaf9f9cd1bb092c8059837996d4d5ab9088d))
...
* **workflow:** add JSON output for sharing commands ([#750](https://github.com/tiborsimko/reana-client/issues/750)) ([eac1fb9](https://github.com/tiborsimko/reana-client/commit/eac1fb92284ce1a5fdf3eebba01daae629cbc89d)), closes [#712](https://github.com/tiborsimko/reana-client/issues/712)
...
* **workflow:** add share-status command ([#692](https://github.com/tiborsimko/reana-client/issues/692)) ([807ef40](https://github.com/tiborsimko/reana-client/commit/807ef4089dd72a4c46f7f1a05cca0c316115d131)), closes [#686](https://github.com/tiborsimko/reana-client/issues/686)
* **workflow:** guard deletion of restarted runs ([#759](https://github.com/tiborsimko/reana-client/issues/759)) ([9b298bf](https://github.com/tiborsimko/reana-client/commit/9b298bf14d1f2a7833b87f092a85d3b4d1c09401))


### Bug fixes

* **cli:** suppress pkg_resources deprecation warning ([#764](https://github.com/tiborsimko/reana-client/issues/764)) ([69105b7](https://github.com/tiborsimko/reana-client/commit/69105b7b5046450659b8aaeb77e4b28d7ddd1293))
...
* **config:** use glob for egg-info in flake8 exclude ([#745](https://github.com/tiborsimko/reana-client/issues/745)) ([59059f6](https://github.com/tiborsimko/reana-client/commit/59059f6841cfea35194ec3ea3062974e700b535b))
...
* **pytest:** drop pytest-reana for reana-commons[tests] ([#770](https://github.com/tiborsimko/reana-client/issues/770)) ([50b45a1](https://github.com/tiborsimko/reana-client/commit/50b45a1881166b29523ba83dceafb3bb8e299fed))
...
* **python:** adapt code base to the new black version ([#758](https://github.com/tiborsimko/reana-client/issues/758)) ([b6faeda](https://github.com/tiborsimko/reana-client/commit/b6faedab8a9089c3bbf42b91b90f34bf0afa2ffb))
...
* **snakemake:** cover container image validation ([#775](https://github.com/tiborsimko/reana-client/issues/775)) ([a381927](https://github.com/tiborsimko/reana-client/commit/a381927bf7439b96e160e3930af03394457d8e9a))
...
* **codecov:** fix matrix condition for Codecov Coverage ([#782](https://github.com/tiborsimko/reana-client/issues/782)) ([3158bf5](https://github.com/tiborsimko/reana-client/commit/3158bf5f4908a55488ab976b00fe188d86fcf13d))
...
* **jsonlint:** add JSON linting checks ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([1854cef](https://github.com/tiborsimko/reana-client/commit/1854cef1c77ff10845d4711f9a19c1ca7be179b0))
* **markdownlint:** add Markdown linting checks ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([c994a34](https://github.com/tiborsimko/reana-client/commit/c994a346987cd59c3b0cf32a06d0be7e729d96ca))
...
* **prettier:** add Prettier code formatting checks ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([da63802](https://github.com/tiborsimko/reana-client/commit/da638022e00d1cd2bdba1e525f78873d3735362c))
...
* **python:** pin setuptools below 81 ([#760](https://github.com/tiborsimko/reana-client/issues/760)) ([57cd676](https://github.com/tiborsimko/reana-client/commit/57cd676e40508a86d8984092704b870e4bf9c77c))
* **python:** run all matrix jobs without fast failing ([#763](https://github.com/tiborsimko/reana-client/issues/763)) ([8e79aaa](https://github.com/tiborsimko/reana-client/commit/8e79aaa686b19a1776ee88cd7b0bad36da8adf35))
...
* **release-please:** upgrade action to v5 ([#784](https://github.com/tiborsimko/reana-client/issues/784)) ([8f20dee](https://github.com/tiborsimko/reana-client/commit/8f20dee9caa3d8240ae1d67e3a6915e9d435e059))
...
* **run-tests:** add usage help and refactor options ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([9d90a58](https://github.com/tiborsimko/reana-client/commit/9d90a586b3c4be59fe58ca6fa7b9ef3658eecd29))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#741](https://github.com/tiborsimko/reana-client/issues/741)) ([22c74e5](https://github.com/tiborsimko/reana-client/commit/22c74e5955f60b3fca900462626d3b948e1ee010))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#741](https://github.com/tiborsimko/reana-client/issues/741)) ([639992a](https://github.com/tiborsimko/reana-client/commit/639992a3c13a3b601541f0a04c48afd33008ac62))
...
* **shfmt:** add shfmt code formatting checks ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([2764653](https://github.com/tiborsimko/reana-client/commit/27646538004d48ea08fc01ff11d13a5f57efe5fb))
...
* **yamllint:** add YAML linting checks ([#762](https://github.com/tiborsimko/reana-client/issues/762)) ([2ee30b3](https://github.com/tiborsimko/reana-client/commit/2ee30b33c8a47c445814edfe85f40705538d1edd))
...
* **usage:** add shell completion instructions ([#756](https://github.com/tiborsimko/reana-client/issues/756)) ([03d2270](https://github.com/tiborsimko/reana-client/commit/03d22708f4ad831d2bc4058f4f75077b0db8988f))
